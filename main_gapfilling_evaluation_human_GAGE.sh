		...
		do
			...
			if [ "$tool" = "Salmela" ]; then
				...
				do  
					...
					#/usr/bin/time -v Gap2Seq-0.1.2b -filled $tool_out$filled_scf_name -scaffolds $scaf_path -reads '/proj/b2013169/private/data/gage.cbcb.umd.edu/data/'$genome'/Data.original/shortjump_1.fastq.gz' -k 61 -max-mem 24 -solid 3 1> $tool_out'outsahlin.stdout' 2> $tool_out'outsahlin.stderr'
				#/usr/bin/time -v Gap2Seq-0.1.2 -k 61 -nb-cores 16 -max-mem 32 -solid 3 -filled $tool_out$filled_scf_name -scaffolds  $scaf_path -reads $lib_path2 1> $tool_out'outsahlin.stdout' 2> $tool_out'outsahlin.stderr'	
					/usr/bin/time -v Gap2Seq-0.1.3 -k 61 -nb-cores 16 -max-mem 32 -solid 3 -filled $tool_out$filled_scf_name -scaffolds  $scaf_path -reads $lib_path1','$lib_path2 1> $tool_out'outsahlin.stdout' 2> $tool_out'outsahlin.stderr'
				done
			...
			if [ "$tool" = "original" ]; then
				...
				do  
					...
					python length_sum_misassembles_quast.py  $quast_ctg_rep_stdout	$quast_misass $quast_report	$gnu_time_mem $outpath --N 4000
	 				...
	 				outpath='/proj/b2013169/private/data/gap_filling/'$tool'/'$genome'/'$assembly'/'
	 				python average_results.py $outpath 1 
...
python make_csv_for_latex.py -q '/home/kris/Work/gap_filling/main_output/quast_table_Hg_chr14.csv' -o '/home/kris/Work/gap_filling/main_output/saur_quast.csv'
...
python make_csv_for_latex.py -p '/home/kris/Work/gap_filling/main_output/performance_table_Hg_chr14.csv' -o '/home/kris/Work/gap_filling/main_output/saur_perf.csv'
